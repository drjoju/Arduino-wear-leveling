ReadMe file for Arduino Wear Leveling Library v1.0
...
--------------------------------------------------------------------------------
To use the library:
(1) Go to https://github.com/drjoju/Arduino-wear-leveling and click the ZIP button to
...
for example "xxxxxx-master".
(3) Rename the folder to just "Wear_leveling".
